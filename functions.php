...
class Bootstrap_walker extends Walker_Nav_Menu{
  ...
  function start_el(&$output, $object, $depth = 0, $args = Array(), $current_object_id = 0){
    ...
    $item_output .= '<a'. $attributes .'><span class="icon-menu">';
    $item_output .= $args->link_before .apply_filters( 'the_title', $object->title, $object->ID );
    $item_output .= $args->link_after;

    // if the item has children add the caret just before closing the anchor tag
    if ( $args->has_children ) {
    	$item_output .= '</span><b class="caret"></b></a>';
    }
    else {
    	$item_output .= '</span></a>';
    }
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        ...
        wp_enqueue_style( 'wpbs-style' );
         // dashicons css
        wp_register_style( 'wpbs-dashicons', site_url(). '/wp-includes/css/dashicons.min.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'wpbs-dashicons' );

        // back-top css
        wp_register_style( 'back-top', get_template_directory_uri().'/css/style.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'back-top' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script(  'modernizr', 
      ...
      wp_register_script(  'modernizr-2', 
...
/************ Add scripts ************/
  // js Smooth Chrome Scrolling 
  //if(ot_get_option('smooth_chrome') == 'on'){
   // wp_register_script( 'smooth-scroll-scripts',get_template_directory_uri() . '/library/js/smooth-scroll.js',array('jquery'),'1.2' );
