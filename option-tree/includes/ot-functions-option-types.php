...
/**
 * Textarea no tinymce option type. - edit by TP
 *
 * See @ot_display_by_type to see the full list of available arguments.
 *
 * @param     array     An array of arguments.
 ...
 * @since     2.0
 */
if ( ! function_exists( 'ot_type_textarea_default' ) ) {
   function ot_type_textarea_default( $args = array() ) {
    ...
    echo '<div class="format-setting type-text ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* build text input */
        echo '<textarea name="' . esc_attr( $field_name ) . '" id="textarea_' . esc_attr( $field_id ) . 'class="widefat' . esc_attr( $field_class ) . '">'. esc_attr( $field_value ).' </textarea>';
        //echo '<textarea class="hidden" id="textarea_' . esc_attr( $field_id ) . '" name="' . esc_attr( $field_name ) .'">' . esc_attr( $field_value ) . '</textarea>';
